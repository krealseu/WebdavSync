...
import org.kreal.webdav.sync.client.NetworkUtilities;
import org.kreal.webdav.sync.client.RawContact;
import org.kreal.webdav.sync.platform.ContactManager;
...
//            This value to the server, we can just get the contacts that have
            ...
            Log.d(TAG, "Calling contactManager's sync contacts" + "  " + authority);
